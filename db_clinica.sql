...
CREATE TABLE `area` (
  ...
  PRIMARY KEY (`idArea`),
  UNIQUE KEY `idMedico` (`idMedico`,`idEspecialidade`),
  KEY `fk_idEspecialidade` (`idEspecialidade`),
  CONSTRAINT `area_ibfk_1` FOREIGN KEY (`idMedico`) REFERENCES `medico` (`idMedico`),
...
CREATE TABLE `especialidade` (
  ...
  UNIQUE KEY `col_especialidade` (`especialidade`)
...
-- Dump completed on 2019-05-17 16:42:28
